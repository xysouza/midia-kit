import { Box, Heading, Text, Stack, SimpleGrid, VStack, Icon, useColorModeValue, List, ListItem, ListIcon } from '@chakra-ui/react'
      ...
      >
        <Box maxW="3xl" textAlign="center">
          ...
          <Text mt={3} color={secondaryText}>
            Os pilares que sustentam a criação de conteúdo e a relação com a comunidade e parceiros.
          </Text>
        </Box>

        <SimpleGrid columns={{ base: 1, sm: 2, lg: 4 }} spacing={{ base: 5, lg: 8 }} w="full">
